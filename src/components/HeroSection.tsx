  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center justify-between gap-8 animate-fade-in">
      <div className="w-full md:w-1/2 space-y-6">
        ...
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text">
      ...
      <div className="w-full md:w-1/2 flex justify-center">
        <div className="relative">
          ...
          <div className="glass p-3 md:p-5 rounded-xl shadow-lg">
            <img 
              src="https://f002.backblazeb2.com/file/appimages/find_my_pixs.jpeg"
              alt="Find My Pix" 
