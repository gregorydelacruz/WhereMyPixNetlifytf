    ...
    <section id="feature-section" className="w-full max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="glass p-6 rounded-xl hover:shadow-md transition-all">
          ...
          <p className="text-muted-foreground">Scattered photos? Our Advanced AI automatically sorts them into neatly labeled folders—no manual effort needed.</p>
        </div>
        ...
        <div className="glass p-6 rounded-xl hover:shadow-md transition-all">
          ...
          <p className="text-muted-foreground">No more confusing file names! Advanced AI assigns clear, meaningful names to each photo, making searching effortless.</p>
        </div>
        ...
        <div className="glass p-6 rounded-xl hover:shadow-md transition-all">
          ...
          <p className="text-muted-foreground">Stop scrolling endlessly! AI-powered tagging lets you locate any image in seconds.  (Coming Soon) </p>
        </div>
